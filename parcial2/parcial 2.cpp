...
void Leer(){
	...
	cout<<"No."<<"|"<<"ID"<<"|"<<"Nombre"<<"|"<<"Apellido"<<"|"<<"Nota 1"<<"|"<<"Nota 2"<<"|"<<"Nota 3"<<"|"<<"Nota 4"<<"|"<<"Promedio"<<"|"<<"Estado"<<endl;
	cout<<"------------------------------------------------------------------------"<<endl;
	do{
		cout<<id<<"  |"<<estudiante.codigo<<"|"<<estudiante.nombres<<" "<<estudiante.apellidos<<"| "<<estudiante.nota1<<" | "<<estudiante.nota2<<" | "<<estudiante.nota3<<" | "<<estudiante.nota4<<" | "<<estudiante.promedio<<"%  |";
